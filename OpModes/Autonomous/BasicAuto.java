...
//                secondStoneBackup = 8.0 + cons.skystoneExtraBack;// was 10.0
//            }
//            if(stonePos.equals("Left")) {
//
...
//            if(stonePos.equals("Center")) {
//
//                stoneSideways = 6.5 + cons.skystoneExtraSideways;// was 7.5
...
//        Billy.IMUDriveFwdRight(HardwareRobot.moveDirection.FwdBack, cons.forwardFirstMove, 0,"Forward 16 inches",this);
//
////        pressAToContinue();
//    }
...
//
//        Billy.IMUDriveFwdRight(HardwareRobot.moveDirection.RightLeft, (7.5 * sideColor), 0, "Right 7.5 inches",this);
//    }
...
//        Billy.IMUDriveFwdRight(HardwareRobot.moveDirection.RightLeft,10 * sideColor,  0,"sideways with foundation",this);// was 4
//
...
//        Billy.IMUDriveFwdRight(HardwareRobot.moveDirection.RightLeft,16 * sideColor,  0,"sideways without foundation",this);// was 4
//
...
//        Billy.IMUDriveFwdRight(HardwareRobot.moveDirection.RightLeft,-6 * sideColor,  -90*sideColor,"sideways without foundation to push",this);// was 4
//
//        // grab foundation with servos
//        Billy.servoFoundationL.setPosition(0.80);
//        Billy.servoFoundationR.setPosition(0.20);
...
//        Billy.IMUDriveFwdRight(HardwareRobot.moveDirection.FwdBack,13,  -90*sideColor,"Forward pushing foundation",this);// was 4
//
//        //release foundation from servos
//        Billy.servoFoundationL.setPosition(0.10);
//        Billy.servoFoundationR.setPosition(0.90);
...
//        Billy.IMUDriveFwdRight(HardwareRobot.moveDirection.FwdBack, -6, -90*sideColor, "backup to clear foundation", this);
//        //move right/left to align with bridge
//        Billy.IMUDriveFwdRight(HardwareRobot.moveDirection.RightLeft, (-2-insideOutside)*sideColor, -90*sideColor, "align to inside or outside", this);
//        //finish backing up to bridge
//        Billy.IMUDriveFwdRight(HardwareRobot.moveDirection.FwdBack, -45, -90*sideColor, "backup", this);
//
//
//    }
//
...
//
////        Billy.IMUDriveRotate(-90 * sideColor, "Rotate 90 degrees CCW",this);
//        Billy.IMUDriveFwdRight(HardwareRobot.moveDirection.FwdBack, stoneSideways,-90 * sideColor, "Forward to align with stone",this);
//
////        pressAToContinue();
//
//    }
...
//
//        Billy.IMUDriveFwdRight(HardwareRobot.moveDirection.RightLeft, cons.sideGrabSkystone * sideColor, -90 * sideColor, "Right 8 inches",this);
//
////        pressAToContinue();
...
////        pressAToContinue();
//
//        Billy.IMUDriveFwdRight(HardwareRobot.moveDirection.RightLeft, (-(cons.sidePullSkystone)) * sideColor, -90 * sideColor, "Left 8 inches",this);
//
////        pressAToContinue();
//
...
////        pressAToContinue();
//
//        Billy.IMUDriveFwdRight(HardwareRobot.moveDirection.FwdBack, (-(bridgeBack + cons.backTowardsBridge)), -180 * sideColor, "Back 2 inches",this);
//
////        pressAToContinue();
//
//        Billy.IMUDriveFwdRight(HardwareRobot.moveDirection.RightLeft, ((50 + extraRedDistance) - stoneSideways) * sideColor, -180 * sideColor, "Right 52+ inches",this);
//                                                                            // was 47
////        pressAToContinue();
//
...
//
//        Billy.IMUDriveFwdRight(HardwareRobot.moveDirection.RightLeft,( (-36 - (extraRedDistance / 2)) + stoneSideways - 24 ) * sideColor, -180 * sideColor, "Left 45+ inches",this);
//                                                                                // was -35 and -38
////        pressAToContinue();
//
...
////        pressAToContinue();
//
//        Billy.IMUDriveFwdRight(HardwareRobot.moveDirection.FwdBack, -secondStoneBackup, -90 * sideColor, "Left 8 inches",this);
//
////        pressAToContinue();
//
//    }
...
//
//        Billy.IMUDriveFwdRight(HardwareRobot.moveDirection.RightLeft, (cons.sideGrab2Skystone) * sideColor, -90 * sideColor, "Right 8 inches",this);
//
////        pressAToContinue();
//
//        //grab skystone with servo arm
...
////        pressAToContinue();
//
//        Billy.IMUDriveFwdRight(HardwareRobot.moveDirection.FwdBack, secondStoneBackup, -90 * sideColor, "Right 8 inches",this);
//
////        pressAToContinue();
//
//        Billy.IMUDriveRotate( -180 * sideColor, "Rotate 90 degrees CCW",this);
...
////        pressAToContinue();
//
//        Billy.IMUDriveFwdRight(HardwareRobot.moveDirection.RightLeft, ( (34 + extraRedDistance) - stoneSideways + 24) * sideColor, -180 * sideColor, "Right with stone 2",this);
...
//        if(sideColor == 1) {
//
//            Billy.IMUDriveFwdRight(HardwareRobot.moveDirection.RightLeft,-13 * sideColor, -180 * sideColor, "Left 10 inches",this);
//
//        }
//        if(sideColor == -1) {
//
//            Billy.IMUDriveFwdRight(HardwareRobot.moveDirection.RightLeft,-10 * sideColor, -180 * sideColor, "Left 10 inches",this);
//
//        }
//
//    }
...
//        Billy.servoFoundationR.setPosition(0.90);
//
//        Billy.IMUDriveFwdRight(HardwareRobot.moveDirection.FwdBack, 36, 0,"Forward 36 inches to Foundation", this);
...
//
//        Billy.IMUDriveFwdRight(HardwareRobot.moveDirection.FwdBack, 2,0,"Forward 2 inches to Foundation", this);
//
//        // grab foundation with servos
//        Billy.servoFoundationL.setPosition(0.80);
//        Billy.servoFoundationR.setPosition(0.20);
...
//
//        Billy.IMUDriveFwdRight(HardwareRobot.moveDirection.FwdBack, -29, 0, "Backward 29 inches with Foundation", this);
//
...
//
//        Billy.IMUDriveFwdRight(HardwareRobot.moveDirection.FwdBack, -33, -10 * sideColor, "Backward 31 inches at 5 CCW with Foundation", this);
//
...
//        Billy.servoFoundationR.setPosition(0.90);
//
//        Billy.IMUDriveFwdRight(HardwareRobot.moveDirection.FwdBack, 4, 0,"Forward 36 inches to Foundation", this);
//
//        Billy.IMUDriveFwdRight(HardwareRobot.moveDirection.RightLeft, -12 * sideColor, 0, "Left 12 inches", this);//NEW
//
//        Billy.moveJack(1, (cons.JACK_POWER_LIMIT / 2), "Move Jack up 3 inches", this);// height is wrong because degtocount is for 40:1
//
//        Billy.IMUDriveFwdRight(HardwareRobot.moveDirection.FwdBack, 25, 0,"Forward 36 inches to Foundation", this);
...
//
//        Billy.IMUDriveFwdRight(HardwareRobot.moveDirection.RightLeft, 18 * sideColor, 0, "Right 18 inches", this);
//
//        Billy.IMUDriveRotate((-90 * sideColor), "Rotate to 90 degrees CCW",this);
//
////        pressAToContinue();
//
//        Billy.IMUDriveFwdRight(HardwareRobot.moveDirection.FwdBack,12, -90 * sideColor, "Forward 12 inches at 90 CCW with Foundation", this);
//
////        pressAToContinue();
////
...
//        sleep(500);
//
//        Billy.IMUDriveFwdRight(HardwareRobot.moveDirection.FwdBack, -5, -90 * sideColor, "Backward 20 inches at 90 CCW with Foundation", this);
//
//        Billy.IMUDriveFwdRight(HardwareRobot.moveDirection.RightLeft, -31 * sideColor, -90 * sideColor, "Left 25 at 90 CCW with Foundation", this);
//
//        Billy.moveJack(0.20, (cons.JACK_POWER_LIMIT / 2), "Move Jack Down to 0", this);// was 0.25 distance above start
//
//        Billy.IMUDriveFwdRight(HardwareRobot.moveDirection.FwdBack, -40, -90 * sideColor, "Backward 40 inches at 90 CCW with Foundation", this);
//
//    }
//
//    public void awayFromFoundationOneMove() {
//
//        Billy.IMUDriveFwdRight(HardwareRobot.moveDirection.FwdBack, -2,  (-20 * sideColor),"Backward 2 inches away from Foundation", this);
//
//        Billy.IMUDriveFwdRight(HardwareRobot.moveDirection.RightLeft, (50 * sideColor), 0,"Right 25 inches", this);//was 21
//
//    }
//
...
//        Billy.IMUDriveFwdRight(HardwareRobot.moveDirection.FwdBack, -2,  (-20 * sideColor),"Backward 2 inches away from Foundation", this);
//
//        Billy.IMUDriveFwdRight(HardwareRobot.moveDirection.RightLeft, (26 * sideColor),(-20 * sideColor),"Right 26 inches around Foundation", this);
//
//        Billy.IMUDriveFwdRight(HardwareRobot.moveDirection.FwdBack, 18,(-20 * sideColor),"Forward 18 inches around Foundation", this);
//
//    }
//
...
//
//        Billy.IMUDriveFwdRight(HardwareRobot.moveDirection.RightLeft, (-foundationPush * sideColor), 0,"Right 8 inches pushing Foundation", this);
//
//        Billy.IMUDriveFwdRight(HardwareRobot.moveDirection.RightLeft, (foundationPush * sideColor), 0,"Left 8 inches away from Foundation", this);
//
//    }
//
...
////        //was 50
//
//        Billy.IMUDriveFwdRight(HardwareRobot.moveDirection.RightLeft, (25 * sideColor),(-20 * sideColor),"Right 25 inches", this);//was 21
//
//        Billy.IMUDriveRotate( 0,"Rotate 20 degrees CW", this);//15 was too close
//
//        Billy.IMUDriveFwdRight(HardwareRobot.moveDirection.FwdBack, -10, 0, "Backward 14 inches to wall", this);//was 16
//
//        Billy.IMUDriveFwdRight(HardwareRobot.moveDirection.RightLeft, (20 * sideColor), 0, "Right 20 inches", this);//was 24
//
//    }
//
...
//            Billy.IMUDriveFwdRight(HardwareRobot.moveDirection.FwdBack, -12, (-10 * sideColor)*h, "backup", this);
//        }
...
//
//        Billy.IMUDriveFwdRight(HardwareRobot.moveDirection.FwdBack, -6, -90*sideColor, "backup to clear foundation", this);
//        Billy.IMUDriveFwdRight(HardwareRobot.moveDirection.RightLeft, (24-insideOutside)*sideColor, -90*sideColor, "align to inside or outside", this);
...
//         */
//
//        Billy.IMUDriveFwdRight(HardwareRobot.moveDirection.FwdBack, -44, -90*sideColor, "backup", this);
//
//    }
